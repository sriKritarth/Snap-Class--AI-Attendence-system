...
from src.db.db import get_all_students , create_student , get_students_subject ,get_students_attendance ,unenroll_student_to_subject
...
def student_dashboard():
    ...
    with st.spinner("Loading your enrolled subjects..."):
        subject = get_students_subject(student_id)
        ...
        for i , sub_node in enumerate(subject):
            ...
            def unenroll_btn():
                if st.button("Unenroll from this course" , type = 'tertiary' , width='stretch' , icon=":material/delete_forever:"):
                    ...
                    st.toast(f"Unenroll from {sub['name']}")
                    st.rerun()
